...
pub async fn spawn_app() -> TestApp {
    ...
    let configuration = {
        ...
        c.database.database_name = Uuid::new_v4().to_string(); // Use a different database for each test case
        c.application.port = 0; // Use a random OS port
    ...
    // Build the application and run the server as a background task
    // Notice the clone! this is needed to use configuration below, else rust passes the ownership
